...
class TecladoPageMayus extends StatefulWidget {
  static const routeName = 'teclado';
  const TecladoPageMayus({super.key});

  @override
  State<TecladoPageMayus> createState() => _TecladoMayusPageState();
}

class _TecladoMayusPageState extends State<TecladoPageMayus> {
